...
<main class="container max-w-2xl mx-auto space-y-8 mt-8 px-2 min-h-screen">
        ...
        <section
            ...
            <div class="flex gap-4 justify-center flex-col text-center items-center">
                ...
                <div>
                    @if (Auth::check())
                    <img class="h-24 mx-auto mb-5" src="{{ asset('storage/' . Auth::user()->profile_picture) }}" alt="">
                    <p class="font-bold md:text-2xl">Welcome, {{ Auth::user()->name }}!</p>
                    <p class="text-gray-700">{{ Auth::user()->bio }}</p>
                @else
                    <p>You are not logged in.</p>
                    <p><a href="./login" type="button"
                        class="m-2 flex items-center text-center rounded-full px-8 py-2 font-semibold bg-gray-100 hover:bg-gray-200 text-gray-700">
                        Login
                    </a></p>
                @endif
