                ...
                <div class="relative ml-3" x-data="{ open: false }">
                    ...
                    <div>
                        <button @click="open = !open" type="button"
                            ...
                            <img class="h-8 w-8 rounded-full" src="{{ asset('storage/' . Auth::user()->profile_picture) }}" />
                        </button>
                    </div>
                    @else
                    <button @click="open = !open" type="button"
                            ...
                            id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                            <span class="sr-only">Open user menu</span>
                            <svg width="32px" height="32px" viewBox="-4.16 -4.16 24.32 24.32" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)"><rect x="-4.16" y="-4.16" width="24.32" height="24.32" rx="12.16" fill="#f5f5f5" strokewidth="0"></rect></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.032"></g><g id="SVGRepo_iconCarrier"> <path d="M8 7C9.65685 7 11 5.65685 11 4C11 2.34315 9.65685 1 8 1C6.34315 1 5 2.34315 5 4C5 5.65685 6.34315 7 8 7Z" fill="#000000"></path> <path d="M14 12C14 10.3431 12.6569 9 11 9H5C3.34315 9 2 10.3431 2 12V15H14V12Z" fill="#000000"></path> </g></svg>
                        </button>
                    @endif
                    <!-- Dropdown menu -->
